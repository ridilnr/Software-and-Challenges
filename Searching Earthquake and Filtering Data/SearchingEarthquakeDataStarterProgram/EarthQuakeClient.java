...
public class EarthQuakeClient {
    ...
    public void closeToMe(){
        ...
        if(close.size() > 0){
            ...
            System.out.println("No earthquakes are found.");
        }
    }
    ...
    public void quakesByPhrase(){
        ...
        ArrayList<QuakeEntry> list  = parser.read(source);
        System.out.println("# quakes read: " + list.size());
        String[] whereAndPhrase = {"any", "Can"};
        ArrayList<QuakeEntry> listPhrase = filterByPhrase(list, whereAndPhrase[0], whereAndPhrase[1]);
        for (QuakeEntry qe : listPhrase) {
           System.out.println(qe); 
        }
        System.out.println("Found "+listPhrase.size()+" quakes that match "+whereAndPhrase[1]+" at "+whereAndPhrase[0]);
    }
}
